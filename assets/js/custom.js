$(document).ready(function () {
    var planets = [{
        ...
        },
        {
            ...
            This giant planet comes in first again when it comes to giving off heat. The core of Jupiter may be made of liquid rock that reaches temperatures of 43,000° F (23,870° C).There are at least 63 moons of different sizes orbiting Jupiter. That's the most of any planet. Its largest moon is called Ganymede. It has a diameter of 3,400 miles (5,472 km)—larger than Mercury!`
        },
        {
            name: 'Saturn',
    ...
    $('.navbar-nav li a').click(function (e) {
        ...
        planets.forEach(function (planet) {
            if ($parent[0].innerText === planet.name) {
